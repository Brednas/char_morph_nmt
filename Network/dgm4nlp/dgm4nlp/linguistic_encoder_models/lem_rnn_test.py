...
from dgm4nlp.linguistic_encoder_models.lem_ae import test_auto_encoder
...
base_dir = '/mnt/data/sander/experiments/final_models_rnn'
os.makedirs(base_dir, exist_ok=True)  # make sure base_dir exists
output_dir = tempfile.mkdtemp(prefix = 'lemonly_rnn_', suffix=datetime.now().strftime("%y-%m-%d.%Hh%Mm%Ss."), dir=base_dir)
